...
<div class="wrapper">
    <div class="row">
        <div class="top-list">
            <span class="title-content">Cadastrar Formulario</span>
            ...
            <form method="POST" action="" id="form-add-color" class="form-adm">
                <div class="row-input">
                    <div class="column">
                        ...
                        <input type="text" name="nome" id="name" class="input-adm" placeholder="Digite o nome da cor" value="<?php echo $name; ?>"  required>
                    </div>
                </div>
